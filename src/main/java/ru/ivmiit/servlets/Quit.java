    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(optionalEvent.isPresent()){
            ...
            if(events.contains(event)){
                eventsService.leaveEvent(event,currentUser);
                result = "Вы успешно покинули мероприятие.";
            }else{
                result = "Вы и так не участвуете в этом мероприятии!";
            }
        }else{
            result = "Мероприятие, из которого вы пытаетесь выйти, не существует.";
        }
